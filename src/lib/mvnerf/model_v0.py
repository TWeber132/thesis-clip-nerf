...
from lib.mvnerf.layers import MVResNetMLPNeRFEmbedding, RenderReadout, VisualFeatures, CombineCLIPVisualV0
...
class MVVNeRFRenderer(tf.keras.Model):
    def __init__(self, n_rays_train, n_rays_infer, n_views=2, n_samples=64, n_features=256,
        ...
        self.combine_clip_visual_features = CombineCLIPVisualV0()
