...
from lib.mvnerf.layers import VisualFeatures, MVResNetMLPNeRFEmbedding, CombineCLIPVisualV2
from lib.lmvnerf.layers import Tile
...
class LanguageNeRF(tf.keras.Model):
    def __init__(self, n_features=256, original_image_size=(480, 640), n_points_train=5,
        ...
        self.tile = Tile(shape=(self.batch_size, 240, 320, 256))
    ...
    def call(self, inputs, training=False, mask=None):
        ...
        clip_textuals_tiled = self.tile(                    # [(BN) 240 320 256]
            clip_textuals)
        combined_features = tf.math.multiply(
            combined_features, clip_textuals_tiled)         # [(BN) 240 320 256] instead of 1024
